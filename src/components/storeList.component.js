...
export class StoreList extends Component {
    ...
    constructor (props){
        ...
        this.handleCrowdLevelChange = this.handleCrowdLevelChange.bind(this);
        this.showSeniorForm = this.showSeniorForm.bind(this);
        this.seniorFormExistsChangeHandle = this.seniorFormExistsChangeHandle.bind(this);
        this.handleChangeForSeniorHoursForm = this.handleChangeForSeniorHoursForm.bind(this);
        this.submitSeniorHoursInfo = this.submitSeniorHoursInfo.bind(this);
